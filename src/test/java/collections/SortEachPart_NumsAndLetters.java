...
/*
    ...
    */
public class SortEachPart_NumsAndLetters {

    public static void main(String[] args) {

        System.out.println(sortEach("DC501GCECA098911"));
    }

    public static String sortEach(String str) {
        //DC501
        String sorted = ""; // where the final result is stored
        String each = ""; // where the substring of each part (digit/letter) -- > DC-501-GCECA-098911
